...
module.exports.routes = {
  ...
  'GET /patient':  { controller: 'PatientController', action:'getPatients' },
  'GET /patient/:PatientId':  { controller: 'PatientController', action:'getPatient' },
  'GET /patient-profile/:PatientId':  { controller: 'PatientController', action:'getPatientProfile' },
  'POST /patient/:PatientId':  { controller: 'PatientController', action:'savePatient' },
  'POST /patient':  { controller: 'PatientController', action:'savePatient' },
  'GET /patient/check-phone':  { controller: 'PatientController', action:'checkPhone' },
  'GET /patient/check-email':  { controller: 'PatientController', action:'checkEmail' },
  'POST /patient/change-state':  { controller: 'PatientController', action:'updateState' },
